    ...
    return (
        <>
            <GameLayout src="/homepage_bg.jpeg" alt="Create Room">
                ...
                <ConfigBox InitHp_min={InitHp_min} InitHp_max={InitHp_max} MaxTurn_min={MaxTurn_min}
                           MaxTurn_max={MaxTurn_max} InitBudget_min={InitBudget_min} InitBudget_max={letInitBudget_max}
                           MaxBudget_min={MaxBudget_min} MaxBudget_max={MaxBudget_max} InterestPct_min={InterestPct_min}
                           InterestPct_max={InterestPct_max} HexPurchaseCost_min={HexPurchaseCost_min}
                           HexPurchaseCost_max={letHexPurchaseCost_max} SpawnCost_min={SpawnCost_min}
                           SpawnCost_max={SpawnCost_max} MaxSpawn_min={MaxSpawn_min}
                           MaxSpawn_max={MaxSpawn_max}></ConfigBox>
                <CodeHost></CodeHost>
                ...
                <Button src="" alt="Back" overlayText="Back" bottom="-320" left="270" color="#6a0dad"
                        onClick={moveToDuelSelectPage} font_size="70" height="90" width="200"/>
