...
// possibly fetch(env.LINK+"/???")
  ...
  if (!isAuthorized) {
    ...
    tracking-[5px] ">
                    ...
                    <Button src="/grey_btn.PNG" alt="Create Room" overlayText="Create Room" font_size="" height="300" width="500" color="grey" bottom="-110" left="-500" onClick={() => moveToConfigPage("Duel")}></Button>
                    <Button src="/grey_btn.PNG" alt="Join Room" overlayText="Join Room" font_size="20" height="300" width="500" color="grey" bottom="-110" left="0" onClick={moveToJoinRoomPage} ></Button>
