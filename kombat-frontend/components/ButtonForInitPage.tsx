...
export default function ButtonForInitPage({
                                              src,
                                              alt,
                                              overlayText,
                                              onClick,
    ...
    return (
        <div onClick={onClick} className={`${animationClass} absolute z-120  opacity-${opacity}`}
             style={{height: `${height}px`, width: `${width}px`, bottom: `${bottom}px`, left: `${left}px`}}>
            <div>

                <Image src={src} alt={alt} fill>
                </Image>
                <h1 className={`${animationClass} absolute inset-0 top-[30px] flex items-center justify-center text-black mb-15 opacity-${opacity}`}
