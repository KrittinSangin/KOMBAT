    ...
    return (
        <>
            <div className=" absolute top-[190px] left-[990px]">
                ...
                <img className="absolute left-[60px] bottom-[80px]" src={"/minions/" + images[incrementer] + ".png"}
            ...
            <div className="absolute top-[550px] left-[1010px] w-50 h-15 ">
                ...
                <input type="text" value={minionName} onChange={minionNameChange}
            ...
            <div className="bg-white absolute">
                <Slider min={sliderRange.defFactor.min} max={sliderRange.defFactor.max} bottom={120} left={left}
                        ...
                        value={config.defFactor} setState={handleDefFactorChange}></Slider>
            </div>
        </>
    )
}